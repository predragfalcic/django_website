...
class CaptchaField(MultiValueField):
    def __init__(self, *args, **kwargs):
        ...
        if 'error_messages' not in kwargs or 'invalid' not in kwargs.get('error_messages'):
            ...
            kwargs['error_messages'].update({'invalid': ugettext_lazy('The characters you entered are not valid. Please try again.')})
    ...
    def clean(self, value):
        ...
        if settings.CAPTCHA_TEST_MODE and response.lower() == 'passed':
            ...
            try:
                ...
                raise ValidationError(getattr(self, 'error_messages', {}).get('invalid', ugettext_lazy('The characters you entered are not valid. Please try again.')))
        return value
